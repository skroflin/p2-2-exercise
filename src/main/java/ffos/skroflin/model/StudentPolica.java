 ...
 * @author Korisnik
 */
@Entity(name = "student_polica")
public class StudentPolica extends Entitet{
    ...
    private int visina;
    @ManyToOne
    private StudentProstorija studentProstorija;
    ...
    public StudentProstorija getStudentProstorija() {
